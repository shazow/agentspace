...
3. `agentspace-import` takes a static bundle from the outbox, presents it for review, then merges it into the current repo. Lots of room for improvement here in terms of UX and tooling, perhaps a separate AI-assisted review workflow.
